      ...
      <div className="project-container left-to-right">
        ...
        <div className='project-text animate'>
          ...
          <div className='project-tags-and-link-container'>
            ...
            <div><a href='https://www.github.com/idoshen/Wordle-Solver' target="_blank" rel="noopener noreferrer"><img src={GitProjectIcon} alt="Git-Project"  className="git-project-link-img"/></a></div>
          </div>
