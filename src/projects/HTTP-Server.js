      ...
      <div className="project-container right-to-left">
        ...
        <div className='project-text animate'>
          ...
          <div className='project-tags-and-link-container'>
            ...
            <div><a href='https://www.github.com/idoshen/HTTP-Server' target="_blank" rel="noopener noreferrer"><img src={GitProjectIcon} alt="Git-Project"  className="git-project-link-img"/></a></div>
          </div>
