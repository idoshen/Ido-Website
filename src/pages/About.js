    ...
    <section id="about" className="about animate">
      ...
      <div className="about-bottom-row">
        ...
        <div className="about-bottom-right">
          <p className='about-p'>Some of my relevant electives include Machine Learning, Deep Learning and Image Understanding, Image Processing and Analysis, Natural Language Processing, Reinforcement Learning, Statistics and Data Analysis, and Computer Graphics.<br></br><br></br>
